...
{
    public partial class Trapecio_Compuesta_Multiple : Form
    {
        public Trapecio_Compuesta_Multiple()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            resultado = MetIntegracion.IntegralDoble_trapecio(a, b, c, d, n_x, n_y);
